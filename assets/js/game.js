...
(function (Game) {
    ...
    let frameCounterLimit = 10;

    function speedIncreament(){
        for(i=score; i%10==0; i++ ){
            frameCounterLimit-=2
        }
    }
    ...
    function eatApple() {
        ...
        //increase snake's speed after eating an apple
        speedIncreament()
        
        //change color when an apple is eaten
        randomSnakeColor()
    ...
    function drawApple() {
        ...
        context.fillRect(apple.x, apple.y, CELL_SIZE - 1, CELL_SIZE - 1);
            ...
            context.fillStyle = apple.color2;
        context.fillRect(apple.x, apple.y, CELL_SIZE - 1, CELL_SIZE - 1);
        }
    }
    ...
    document.addEventListener('keydown', function (keyBoardEvent) {
        ...
        // this changes the direction of the snake when the down key is pressed and is not moving on the Y axis
        else if (keyBoardEvent.which=== KEY_DOWN && snake.dy === 0){
            snake.dx= 0;
            snake.dy= CELL_SIZE;
            acceptInput = false;
        }
        //This changes the direction of the snake when the right key is pressed and is not moving on the X axis
